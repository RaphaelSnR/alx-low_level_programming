...
/**
 * check97 - For the check of correct number of arguments
 * @argc: Arguments of variable
 *
 * Return: void
 */
...
/**
 * check98 - From the exist file and can be read to check.
...
/**
 * check99 - File was created and/or can be written to check.
 * @check: If it's true or false check
...
/**
 * check100 - check and close that file descriptors properly.
 * @check: if it's true or false check
 * @fd: File descriptor
 *
 * Return: void
...
/**
 * main - File of the content to another file
 * @argc: Arguments passed
 * @argv: Vector argument (arguments in string form)
 *
 * Return: 0 on success
 */
