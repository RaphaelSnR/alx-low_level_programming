...
/**
 * read_error - Errors are read by functions
 * @argv: argument func
 * Return: void
 */
...
/**
 * check_elf - Check that the format of the file, execute magic num operates
 * @header: The ELF header struct executes
 * Return: void
 */
...
/**
 * check_class - Check that the class of ELF format of the file operates
 * @header: The ELF header struct executes
 * Return: void
 */
...
/**
 * check_data_ver - Check the data and version of ELF operates
 * @header: The ELF header struct executes
 * Return: void
 */
...
/**
 * check_type - Check that the type of ELF file operates
 * @header: The ELF header struct executes
 * Return: void
 */
...
/**
 * check_entry - Check that the type of ELF file operates
 * @header: The ELF header struct execute
 * Return: void
 */
...
/**
 * main - Print ELF header formated
 * @argc: Arguments to passed the program
 * @argv: The program and the ELF file is a string containing
 * Return: 0 on success
 */
